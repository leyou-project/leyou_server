...
public class TAuthSqlProvider {

    public String countByExample(TAuthExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_auth");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(TAuthExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_auth");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(TAuth record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_auth");
    ...
    public String selectByExample(TAuthExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TAuth record = (TAuth) parameter.get("record");
        TAuthExample example = (TAuthExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(TAuth record) {
        SQL sql = new SQL();
        sql.UPDATE("t_auth");
    ...
    protected void applyWhere(SQL sql, TAuthExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
