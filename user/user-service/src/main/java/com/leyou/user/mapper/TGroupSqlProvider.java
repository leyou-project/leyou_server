...
import com.leyou.common.domain.TGroupExample.Criteria;
import com.leyou.common.domain.TGroupExample.Criterion;
...
public class TGroupSqlProvider
{
    ...
    protected void applyWhere(SQL sql, TGroupExample example, boolean includeExamplePhrase)
    {
        if (example == null)
        {
            return;
