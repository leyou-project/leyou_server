...
import com.leyou.common.domain.TGoodsBindExample.Criteria;
import com.leyou.common.domain.TGoodsBindExample.Criterion;
...
public class TGoodsBindSqlProvider
{

    public String countByExample(TGoodsBindExample example)
    {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_goods_bind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(TGoodsBindExample example)
    {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_goods_bind");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(TGoodsBind record)
    {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_goods_bind");
    ...
    public String selectByExample(TGoodsBindExample example)
    {
        SQL sql = new SQL();
    ...
    {
        TGoodsBind record = (TGoodsBind) parameter.get("record");
        TGoodsBindExample example = (TGoodsBindExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("t_goods_bind");
    ...
    public String updateByPrimaryKeySelective(TGoodsBind record)
    {
        SQL sql = new SQL();
        sql.UPDATE("t_goods_bind");
    ...
    protected void applyWhere(SQL sql, TGoodsBindExample example, boolean includeExamplePhrase)
    {
        if (example == null)
        {
            return;
