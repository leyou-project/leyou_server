...
public class TGroupUserSqlProvider
{

    public String countByExample(TGroupUserExample example)
    {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_group_user");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(TGroupUserExample example)
    {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_group_user");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(TGroupUser record)
    {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_group_user");
    ...
    public String selectByExample(TGroupUserExample example)
    {
        SQL sql = new SQL();
    ...
    {
        TGroupUser record = (TGroupUser) parameter.get("record");
        TGroupUserExample example = (TGroupUserExample) parameter.get("example");

        SQL sql = new SQL();
        sql.UPDATE("t_group_user");
    ...
    public String updateByPrimaryKeySelective(TGroupUser record)
    {
        SQL sql = new SQL();
        sql.UPDATE("t_group_user");
    ...
    protected void applyWhere(SQL sql, TGroupUserExample example, boolean includeExamplePhrase)
    {
        if (example == null)
        {
            return;
